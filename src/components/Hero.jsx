...
const Hero = () => {
    return (
        ...
        top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
            ...
            text-white`}>Hi, I'm <span className="text-[#915eff]">Suvanjana</span></h1>
                    <p className={`${styles.heroSubText} mt-2 
            text-white-100`}>
                        I am an UI/UX designer ,  <br className="sm:block hidden" / >currently learning Web Development in depth.
                    </p>
                </div>
            </div>
            <ComputersCanvas/>
